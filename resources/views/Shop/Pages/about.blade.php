   ...
   <div class="container">
      <div class="row row-30">
         ...
         <div class="about-image col-lg-6 mb-50 mb-sm-30 mb-md-30">
            <img src="assets/img/banners/banner-big2.jpg" class="img-fluid" alt="">
         </div>
         <!-- About Content -->
         <div class="about-content col-lg-6">
            <div class="row">
               <div class="col-12 mb-50">
                  <h1>WELCOME TO <span>ALULA.</span></h1>
      ...
      <div class="about-mission-vission-goal row row-20 mb-50 mb-md-20 mb-sm-20">
         <div class="col-lg-4 col-md-6 col-12 mb-md-30 mb-sm-30">
            <h3>OUR VISSION</h3>
            <p>ALULA provide how all this mistaken idea of denouncing pleasure and sing pain was born an will give you a ete account of the system, and expound the actual teangs the eat explorer of the truth, the mer of human tas assumenda est, omnis dolor repellend</p>
         </div>
         <div class="col-lg-4 col-md-6 col-12 mb-md-30 mb-sm-30">
            <h3>OUR MISSION</h3>
            <p>ALULA provide how all this mistaken idea of denouncing pleasure and sing pain was born an will give you a ete account of the system, and expound the actual teangs the eat explorer of the truth, the mer of human tas assumenda est, omnis dolor repellend</p>
      ...
      <div class="row">
         ...
         <div class="about-feature col-md-7 col-12 mb-sm-30">
            <div class="row">
               <div class="col-md-6 col-12 mb-30">
                  <h4>FAST DELIVERY</h4>
                  <p>ALULA provide how all this mistaken dea of denouncing pleasure and sing </p>
               </div>
               <div class="col-md-6 col-12 mb-30">
         ...
         <div class="about-feature-banner col-md-5 col-12">
            <div class="single-banner"><a href="#"><img src="assets/img/banners/slider-banner1.jpg" class="img-fluid" alt="Banner"></a></div>
         </div>
      </div>
   </div>
</div>
